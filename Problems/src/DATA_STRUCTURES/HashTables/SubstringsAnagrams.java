...
/*
    ...
    public static DATA_STRUCTURES.LinkedList<HTObject>[] arr = new DATA_STRUCTURES.LinkedList[ARR_SIZE];
...
*/
    ...
    public static void addToHT(String s, Integer index_value) {
        ...
        DATA_STRUCTURES.LinkedList<HTObject> items = arr[index];

        if(items == null) {
            items = new DATA_STRUCTURES.LinkedList<HTObject>();
